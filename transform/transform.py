...
class Resize(object):
    ...
    def __call__(self, sample):
        ...
        img = sample['image']
        label = sample['label']
        return {'image': F.resize(img, self.size, self.interpolation), 'label': F.resize(label, self.size, self.interpolation)} 
...
class RandomHorizontalFlip(object):
    ...
    def __call__(self, sample):
        ...
        if random.random() < self.p:
            return {'image': F.hflip(img), 'label': F.hflip(label)}
...
class RandomResizedCrop(object):
    ...
    def __call__(self, sample):
        ...
        return {'image': F.resized_crop(img, i, j, h, w, self.size, self.interpolation), 'label': F.resized_crop(label, i, j, h, w, self.size, self.interpolation)} 
...
class RandomRotation(object):
    ...
    def __call__(self, sample):
        ...
        return {'image': F.rotate(img, angle, self.resample, self.expand, self.center), 'label': F.rotate(label, angle, self.resample, self.expand, self.center)}
